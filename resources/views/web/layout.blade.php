    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link {{ Request::is('templates/generate*') ? 'active' : '' }}" {{ Request::is('templates/generate*') ? 'aria-current=page' : '' }} href="{{ route('templates.generateRandom') }}">Generate Random Message</a>
          </li>
      </div>
    </div>
  </nav>
